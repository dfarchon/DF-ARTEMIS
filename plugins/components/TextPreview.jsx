...
export function TextPreview({text, unFocusedWidth, focusedWidth, style}) {
    ...
    return (
        <ShortenedText style={style} width={unFocusedWidth || DEFAULT_UNFOCUSED_WIDTH} onClick={onClick}>
            {text || ""}
        </ShortenedText>
    )
}
